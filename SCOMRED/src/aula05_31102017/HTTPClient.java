...
public class HTTPClient extends Thread{
	...
	private String readLineHTTP() throws IOException {
		...
		this.in.read(); //para ler o último line feed
		return ret;
	}
	...
	private void sendInvalidData() throws IOException {
		String content = this.HTML_HEAD + "<h2>Os dados fornecidos são inválidos.</h2>" + this.HTML_TAIL;
	...
	private void sendNotFound() throws IOException{
		...
		String content = this.HTML_HEAD + "<h3>Endereço Inválido.</h3>" + this.HTML_TAIL;
	...
	private void sendNotImplemented() throws IOException{
		...
		String content = this.HTML_HEAD + "<h3>Operação não suportada.</h3>" + this.HTML_TAIL;
	...
	private void sendStatus() throws IOException{
		...
		String content = this.HTML_HEAD +
				...
				this.cliS.getInetAddress().getLocalHost() + " : " +
				this.cliS.getPort() + this.HTML_TAIL;
